...
:: The logs the mod writes at runtime. They belong here and not in
:: MOD_DLLS because install.cmd errors on any MOD_DLLS entry that is not
:: in the package, and leaving them out of both is what would strand them
:: in the game folder after an uninstall the README calls complete.
